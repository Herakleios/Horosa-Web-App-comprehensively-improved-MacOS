...
<p><strong>Release focus / 本次重点：</strong><code>v1.3.1</code> adds Part of Fortune to primary-direction output, keeps AstroApp-Alchabitius separate from Horosa legacy calculation, and synchronizes AI export with the table result path.</p>
