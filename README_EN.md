...
**Release focus:** `v1.3.1` adds Part of Fortune to primary-direction output, keeps AstroApp-Alchabitius separate from the Horosa legacy calculation, and synchronizes AI export with the same table result path.
